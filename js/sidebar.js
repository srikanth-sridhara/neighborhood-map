jQuery(document).ready(function(){
    ...
    // on desktop - differentiate between a user trying to hover over a dropdown
    // item vs trying to navigate into a submenu's contents
    ...
    function checkSelected(mq) {
        // on desktop, remove selected class from items
        // selected on mobile/tablet version
        if( mq == 'desktop' )
